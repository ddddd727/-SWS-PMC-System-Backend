...
public partial class DspValveOperatorMatlControlDatum
{
    ...
    public virtual ICollection<DspPipingCommodityMatlControlDatum> DspPipingCommodityMatlControlData { get; set; } = new List<DspPipingCommodityMatlControlDatum>();
}
