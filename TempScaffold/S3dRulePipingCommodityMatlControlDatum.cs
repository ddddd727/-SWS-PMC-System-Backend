...
public partial class S3dRulePipingCommodityMatlControlDatum
{
    ...
    public virtual S3dRuleValveOperatorMatlControlDatum? ValveOperatorCatalogPartNumberNavigation { get; set; }
}
