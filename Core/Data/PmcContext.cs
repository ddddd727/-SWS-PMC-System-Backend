...
public partial class PmcContext : DbContext
{
    ...
    public virtual DbSet<PMCSystem_Backend.Modules.PipingSpecifications.Entities.S3dCommonPlainPipingGenericData> S3dCommonPlainPipingGenericData { get; set; }
    ...
    public virtual DbSet<Modules.DesignRules.Entities.S3dRuleShortCodeMap> S3dRuleShortCodeMaps { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Modules.PipingSpecifications.Entities.S3dCommonPlainPipingGenericData>(entity =>
        {
        ...
        modelBuilder.Entity<Modules.DesignRules.Entities.S3dRuleShortCodeMap>(entity =>
        {
